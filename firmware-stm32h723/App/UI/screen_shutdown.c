...
/* =========================================================
 * Layout adjusted for the 220x176 display.
 * The previous NO button coordinates extended beyond the
 * actual screen area and could cause invalid GRAM access.
 * ========================================================= */
...
static void OnButton(ButtonState_t evt)
{
    ...
    if(state == SD_STATE_CONFIRM)
    {
        if(evt.button == BUTTON_ENTER)
        {
            ...
            /* TODO: Call the actual safety/actuator task interface
             * to start the home-position and shutdown sequence.
             */
        }
