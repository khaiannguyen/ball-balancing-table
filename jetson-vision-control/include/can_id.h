...
/*
 * STM32 -> Jetson application CAN identifiers.
 *
 * Base identifier range: 0x100.
 */
...
#define CAN_ID_HEARTBEAT_TX   0x1FF
 ...
 /*
  * Jetson -> STM32 application CAN identifiers.
  *
  * Base identifier range: 0x200.
  */
...
#define CAN_ID_HEARTBEAT_RX      0x2FF
  ...
  /*
   * Dedicated CAN identifier for low-level loopback bring-up tests.
   *
   * This identifier is reserved for communication diagnostics and is not part
   * of the normal application protocol.
   */
